...
1. Znajdz pacjentow po nazwiskuc[x]
2. Znajdz wszystkie wizyty pacjenta po jego ID[x]
3. znajdz pacjentow ktorzy mieli wiecej niz X wizyt (X jest parametrem wejsciowym) [x]
...
1. do zapytania nr 1  - test DAO [x]
2. do zapytania nr 2 - test serwisu [x]
